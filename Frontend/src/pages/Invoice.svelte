      ...
      <div class="row">
        <div class="col-12">
          <div class="callout callout-info">
            <h5><i class="fas fa-info" /> Note:</h5>
          ...
          <div class="invoice p-3 mb-3">
            ...
            <div class="row">
              <div class="col-12">
                <h4>
                  <i class="fas fa-globe" /> AdminLTE, Inc.
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>455-981-221</td>
                      <td
                        >El snort testosterone trophy driving gloves handsome</td
                      >
                      <td>$64.50</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>735-845-642</td>
                      <td
                        >Terry Richardson helvetica tousled street art master</td
                      >
                      <td>$10.70</td>
                    </tr>
                    <tr>
            ...
            <div class="row no-print">
              <div class="col-12">
                <a
                  ...
                  rel="noopener"
                  target="_blank"
                  class="btn btn-default"><i class="fas fa-print" /> Print</a
                >
                <button type="button" class="btn btn-success float-right"
                  ><i class="far fa-credit-card" /> Submit Payment
                </button>
                <button
                  type="button"
