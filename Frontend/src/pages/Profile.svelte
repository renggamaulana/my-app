      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <strong><i class="fas fa-book mr-1" /> Education</strong>
              ...
              <strong><i class="fas fa-map-marker-alt mr-1" /> Location</strong>

              <p class="text-muted">Malibu, California</p>

              <hr />

              <strong><i class="fas fa-pencil-alt mr-1" /> Skills</strong>
              ...
              <strong><i class="far fa-file-alt mr-1" /> Notes</strong>
                  ...
                  <div class="post">
                    ...
                    <p>
                      <a href="#" class="link-black text-sm mr-2"
                        ><i class="fas fa-share mr-1" /> Share</a
                      >
                      <a href="#" class="link-black text-sm"
                        ><i class="far fa-thumbs-up mr-1" /> Like</a
                      >
                      <span class="float-right">
                        <a href="#" class="link-black text-sm">
                          <i class="far fa-comments mr-1" /> Comments (5)
                        </a>
                      </span>
                    </p>
                  ...
                  <div class="timeline timeline-inverse">
                    ...
                    <div>
                      ...
                      <div class="timeline-item">
                        <span class="time"
                          ><i class="far fa-clock" /> 12:05</span
                        >
                    ...
                    <div>
                      ...
                      <div class="timeline-item">
                        <span class="time"
                          ><i class="far fa-clock" /> 5 mins ago</span
                        >
                    ...
                    <div>
                      ...
                      <div class="timeline-item">
                        <span class="time"
                          ><i class="far fa-clock" /> 27 mins ago</span
                        >
                    ...
                    <!-- timeline item -->
                    <div>
                      <i class="fas fa-camera bg-purple" />

                      <div class="timeline-item">
                        <span class="time"
                          ><i class="far fa-clock" /> 2 days ago</span
                        >
